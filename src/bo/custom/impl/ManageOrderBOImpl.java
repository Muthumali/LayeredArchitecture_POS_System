...
public class ManageOrderBOImpl implements ManageOrderBO {
    ...
    public boolean purchaseOrder(OrderDTO dto) throws SQLException, ClassNotFoundException {
        ...
        /*Add Order*/
        Order order = new Order(dto.getOrderId(), dto.getOrderDate(), dto.getOrderTime(),dto.getCustId());
    ...
    public ArrayList<CustomerDTO> getAllCustomers() throws SQLException, ClassNotFoundException {
        ...
        for (Customer c : all) {
            allCustomers.add(new CustomerDTO(c.getCustomerId(), c.getCustomerTitle(), c.getCustomerName(),c.getCustomerAddress(),
    ...
    public CustomerDTO searchCustomer(String s) throws SQLException, ClassNotFoundException {
        ...
        return new CustomerDTO(c.getCustomerId(), c.getCustomerTitle(), c.getCustomerName(),c.getCustomerAddress(),
                c.getCity(),c.getProvince(),c.getPostalCode());
    }
    @Override
